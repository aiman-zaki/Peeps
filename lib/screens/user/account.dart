...
class AccountViewState extends State<AccountView> {
  ...
  Widget build(BuildContext context) {
    ...
    _buildSupervsiorEnableButton() {
      if (widget.data.role == Role.admin){
        return ListTile(
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                  flex: 2,
                  child: _readOnlyFormField(
                      data: widget.data.programmeCode,
    ...
    _buildFrontBody() {
      return Column(
        children: <Widget>[
          ...
          _buildAvatar(),
          FlatButton(
            onPressed: updatePicture == false ? null : _upload,
            child: Text("Upload"),
          ),
          _buildBody(),
        ],
